...
public class Users {
  ...
  public User addNewUserFromStdin() throws UserAlreadyExistsException {
    ...
    user.registration_number(userInput.getLong("Numero de matricula\n>> ", 1000, Long.MAX_VALUE));
    user.first_name(userInput.getText("Nombre\n>> ", 1, Integer.MAX_VALUE));
    user.last_name(userInput.getText("Apellido\n>> ", 1, Integer.MAX_VALUE));
    user.email(userInput.getText("Email\n>> ", UserInput.emailPattern));
    user.phone_number(userInput.getText("Numero de telefono\n>> ", UserInput.phonePattern));
    user.birthdate(
